...
public class TunerConstants {
    ...
    public static final AngularVelocity kOmegaSpeedAt12Volts = DegreesPerSecond.of(360.0);
    public static final AngularAcceleration kOmegaMaxAcceleration =
            DegreesPerSecondPerSecond.of(260);
